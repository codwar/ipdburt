 ...
 * in your data when appropriate, such that you <em>usually</em> don't need to
 * think too much about escaping special characters. Thus, you shouldn't need to
 ...
 * is highly recommended that you use {@link SafeText}, not <tt>String</tt>
 * </span>. Free form user input is open to malicious use, such as <a
 * href='http://www.owasp.org/index.php/Cross_Site_Scripting'>Cross Site
 * Scripting</a> attacks. Using <tt>SafeText</tt> will protect you from such
 * attacks, by always escaping special characters automatically in its
