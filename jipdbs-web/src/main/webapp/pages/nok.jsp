...
<input type="image" src="https://www.paypalobjects.com/WEBSCR-640-20110401-1/es_XC/AR/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal. La forma rápida y segura de pagar en línea.">
